//! Economic-attack regressions: donation attacks, first-supplier share
//! inflation, and partial-liquidation chain convergence. These are
//! classic Aave / Compound attack vectors that the protocol must
//! neutralize through its share-accounting model.
