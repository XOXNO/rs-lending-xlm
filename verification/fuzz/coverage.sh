...
#
# Usage:
#   verification/fuzz/coverage.sh                         # default targets
#   verification/fuzz/coverage.sh fp_math flow_e2e        # explicit target list
#   FUZZ_COV_TIME=30 verification/fuzz/coverage.sh ...    # optional corpus growth
#   SANITIZER=thread verification/fuzz/coverage.sh flow_e2e
#
# Env:
