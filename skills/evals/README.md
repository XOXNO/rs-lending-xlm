...
- Machine checks: generated Rust builds with `stellar contract build` (stellar-cli 25.2 or newer; `soroban-sdk` 28 rejects a plain `cargo build` for a Wasm target) against `soroban-sdk = "28"` and `xoxno-contract-sdk = "0.1"`; generated TypeScript passes `tsc --noEmit` against the `@xoxno/sdk-js` version named in `xoxno-lending-sdk/SKILL.md`
