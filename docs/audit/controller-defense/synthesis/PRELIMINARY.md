...
| A064 | `no_seize` not coupled to `frozen` / does not block supply (ADR-0008 draft) | Can strand liquidations until force_socialize; availability/liveness, not direct theft |
