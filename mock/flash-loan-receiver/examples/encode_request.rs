...
fn main() {
    let mode = std::env::args()
        ...
        .map(|arg| match arg.as_str() {
            ...
            "OverRepay" => FlashLoanMode::OverRepay,
            "PushToPool" => FlashLoanMode::PushToPool,
            "ReenterControllerBorrow" => FlashLoanMode::ReenterControllerBorrow,
            "ReenterControllerWithdraw" => FlashLoanMode::ReenterControllerWithdraw,
            "ReenterControllerRepay" => FlashLoanMode::ReenterControllerRepay,
            "ReenterControllerFlashLoan" => FlashLoanMode::ReenterControllerFlashLoan,
            "ReenterControllerFlashPosition" => FlashLoanMode::ReenterControllerFlashPosition,
            "ReenterControllerMultiply" => FlashLoanMode::ReenterControllerMultiply,
            "ReenterControllerSwapDebt" => FlashLoanMode::ReenterControllerSwapDebt,
            "ReenterControllerSwapCollateral" => FlashLoanMode::ReenterControllerSwapCollateral,
