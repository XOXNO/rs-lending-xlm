...
import {buildStellarSupplyTx,prepareStellarTxXdr} from '@xoxno/sdk-js/stellar-lending';
assert.equal(process.versions.node.split('.')[0],'24');
for (const [name,version] of [['@xoxno/sdk-js','1.0.219'],['@stellar/stellar-sdk','16.0.1']]) {
