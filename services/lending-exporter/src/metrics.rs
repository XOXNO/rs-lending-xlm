...
impl Metrics {
    pub fn new() -> Result<Self> {
        ...
        Ok(Self {
            ...
            oracle_tolerance_upper_bps: register_gauge_vec(&registry, "lending_oracle_tolerance_upper_bps", "Configured upper tolerance ratio (bps, 10000 = parity)", ORACLE_LABELS)?,
            oracle_tolerance_lower_bps: register_gauge_vec(&registry, "lending_oracle_tolerance_lower_bps", "Configured lower tolerance ratio (bps, 10000 = parity)", ORACLE_LABELS)?,
    ...
    pub fn remove_spoke_asset(&self, labels: &[&str; 7]) {
        for gauge in [
            &self.spoke_paused,
            &self.spoke_frozen,
            &self.spoke_collateral_enabled,
            &self.spoke_borrow_enabled,
            &self.spoke_deprecated,
            &self.spoke_ltv_bps,
            &self.spoke_liq_threshold_bps,
            &self.spoke_liq_bonus_bps,
            &self.spoke_liq_fees_bps,
            &self.spoke_supply_cap,
            &self.spoke_borrow_cap,
            &self.spoke_supply_closed,
            &self.spoke_borrow_closed,
            &self.spoke_supply_usage,
            &self.spoke_supply_usage_usd,
            &self.spoke_borrow_usage,
