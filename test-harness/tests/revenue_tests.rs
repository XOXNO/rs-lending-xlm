...
/// Helper: set accumulator address (required for claim_revenue)
...
fn test_claim_revenue_after_interest() {
    ...
    // Claim the revenue (requires accumulator)
    setup_accumulator(&t);
...
fn test_claim_revenue_after_liquidation() {
    ...
    // Alice supplies and borrows near limit
...
fn test_claim_revenue_zero_when_no_activity() {
    ...
    // Claim should return 0 (requires accumulator even for 0)
    setup_accumulator(&t);
...
fn test_add_rewards_increases_supply_index() {
    ...
    // Supply balance should increase because supply index increased
    ...
    // The increase should be roughly 1000 (the reward amount)
...
fn test_add_rewards_rejects_zero() {
    ...
    // Try adding 0 rewards via raw controller call
...
fn test_revenue_role_required() {
    ...
    // Create BOB without REVENUE role
